      ...
      duration: 0.5
        ...
        <div className="max-w-4xl relative z-10">
          ...
          delay: 0.5
            ...
            <Button size="lg" className="button-gradient">QUERO SABER MAIS </Button>
        ...
        delay: 0.6
          ...
          <div className="glass rounded-xl overflow-hidden">
            <img src="/lovable-uploads/c32c6788-5e4a-4fee-afee-604b03113c7f.png" alt="CryptoTrade Dashboard" className="w-full h-auto" />
          </div>
        </motion.div>
      </motion.section>
